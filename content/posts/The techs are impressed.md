...
3. I set up the folder structure Hugo produced as an Obsidian vault then replicated it into a Github repository.
...
5. I created a couple of batch files. One sets up a localhost instance so I can see what it looks like on my PC. Then the other pushes the necessary Obsidian files to the Github repository.
...
I don't expect too many people out there will see this post or even this website. I don't care much. I just wanted to prove to myself that I could get all this technology to mesh as intended. 

It gives me a space to practice writing in public, too. 
